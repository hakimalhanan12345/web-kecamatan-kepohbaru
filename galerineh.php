...
<head>
    <meta charset="UTF-8">
    <title>Galeri Foto | Kecamatan Kepohbaru</title>
...
<section class="gallery-section">
    <div class="gallery-title">
        <h2>Galeri Foto Kecamatan</h2>
        <p>Dokumentasi kegiatan dan potensi wilayah Kepohbaru</p>
    </div>

    <div class="gallery-tabs">
        <button class="tab-btn active" onclick="openTab('foto', this)">
            <i class="fas fa-image"></i> Foto
        </button>
        <a href="galeri_video.php" class="tab-btn">
    ...
    <div id="foto" class="tab-content active">
        <div class="gallery-grid">
            <?php
            $q = mysqli_query($conn, "SELECT * FROM galeri_foto ORDER BY tanggal_upload DESC");
            while ($row = mysqli_fetch_assoc($q)) {
                $foto = "assets/img/galeri/" . $row['nama_file'];
            ?>
            <div class="gallery-item">
                <img src="<?= $foto ?>" alt="<?= $row['judul'] ?>">
